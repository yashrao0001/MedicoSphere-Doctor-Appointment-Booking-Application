...
const Navbar = () => {
  ...
  const logout = () => {
    setToken(false), localStorage.removeItem("token");
  };
  return (
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400">
      <h1 className="w-44 cursor-pointer text-lg" onClick={() => navigate("/")}>
      ...
      <div className="flex items-center gap-4">
        {token && userData ? (
          <div className="flex items-center gap-2 cursor-pointer group relative">
            ...
            <div className="absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block group-active:block">
        ...
        >
          <div className="flex items-center justify-between px-5 py-6">
            <h1
              className="w-44 cursor-pointer text-lg"
              onClick={() => navigate("/")}
            >
              <span className="text-[#5f6FFF] text-2xl">M</span>EDICO
              <span className="text-[#5f6FFF] text-2xl">S</span>PHERE
